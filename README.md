...
ทำนาย **ลูกค้าเสี่ยม** ให้ธนาคารติดต่อและเสนอ **ข้อเสนอพิเศษ** เพื่อรั้งไว้
...
**ข้อมูลที่ใช้:**
- 👤 อายุ, เพศ, ประเทศ
- 💵 เงินเดือน, เงินในบัญชี, Credit Score
- 🕐 อยู่กับธนาคารกี่ปี (Tenure)
- 📦 ใช้บริการกี่ชนิด (Products)
- ✅ บัญชีกำลังใช้งานไหม
- 🎯 **Target:** ปิดบัญชีหรือไม่ (0/1)

---

## 🔍 ผลการวิเคราะห์ข้อมูล

### ลูกค้าเสี่ยมหนีมีลักษณะนี้:
```
